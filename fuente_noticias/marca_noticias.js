...
function imprimirNoticias(equipo) {
    ...
    ajax.addEventListener("load", function () {
        ...
        if (xmlDoc.getElementsByTagName("title")[0].textContent == "LaLiga Santander // marca") {       // Cambiamos el portada marca por ultimas noticias
            h1.textContent = "Últimas noticias | Marca";
        } else {
            h1.textContent = xmlDoc.getElementsByTagName("title")[0].textContent.split("//")[0];
        }
        div.appendChild(h1);
        ...
        for (const noticia of noticias) {
            ...
            if (noticia.getElementsByTagName("media:content")[0] != null) {
                var img = document.createElement("img");
                img.setAttribute("src", noticia.getElementsByTagName("media:content")[0].getAttribute("url"));
            ...
            p.textContent = noticia.getElementsByTagName("media:title")[0].textContent.split("|")[1];
...
function saberEquipo(evento) {
    ...
    if (equipo == "volver-index"){
        ...
        ajax.open("POST", "https://rss-marcas.000webhostapp.com/equipos/marca/equiposMarca.php");
